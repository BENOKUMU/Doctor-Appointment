...
<head>
    ...
    <title>Doctor Patient Scheduling System</title>
...
<body class="text-center">
    <main class="form-signin">
         <form method="post" id="login_form">
            <h1 class="h3 mb-3 fw-normal" style="font-family: 'Merriweather', serif;">Doctor Patient Scheduling System</h1>
            <span id="error"></span>
            ...
            <div class="form-group">
                <button type="submit" name="login_button" id="login_button" class="btn bg-gradient-primary btn-user btn-block">Login</button>
            </div>
        </form>
    </main>
