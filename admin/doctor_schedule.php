      		...
      		<div class="modal-content">
        		...
        		<div class="modal-body">
                    ...
                    <!-- <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fa-thin fa-slot-machine"></i></span>
                            </div>
                            <input type="number" id="num_slots" name="num_slots" min="1" class="form-control" required><br>
                        </div>
                    </div> -->
        		</div>
